 ...
 */
  ...
  BUI.mix(Calendar, {
    Calendar: require("bui-calendar/1.1.1/src/calendar-debug"),
    MonthPicker: require("bui-calendar/1.1.1/src/monthpicker-debug"),
    DatePicker: require("bui-calendar/1.1.1/src/datepicker-debug")
  });

  module.exports = Calendar;

});
define("bui-calendar/1.1.1/src/calendar-debug", ["bui-common/1.1.0/common-debug","jquery","bui-picker/1.1.2/index-debug","bui-overlay/1.1.0/index-debug","bui-list/1.1.1/index-debug","bui-data/1.1.0/index-debug","bui-toolbar/1.1.0/index-debug"], function(require, exports, module){
/**
 * @fileOverview 日期控件
...
var BUI = require("bui-common/1.1.0/common-debug"),
  ...
  MonthPicker = require("bui-calendar/1.1.1/src/monthpicker-debug"),
  Header = require("bui-calendar/1.1.1/src/header-debug"),
  Panel = require("bui-calendar/1.1.1/src/panel-debug"),
...
define("bui-calendar/1.1.1/src/monthpicker-debug", ["jquery","bui-common/1.1.0/common-debug","bui-overlay/1.1.0/index-debug","bui-list/1.1.1/index-debug","bui-data/1.1.0/index-debug","bui-toolbar/1.1.0/index-debug"], function(require, exports, module){
/**
 * @fileOverview 选择年月
 * @author dxq613@gmail.com
 * @ignore
...
var $ = require('jquery'),
  ...
  List = require("bui-list/1.1.1/index-debug").SimpleList,
  Toolbar = require("bui-toolbar/1.1.0/index-debug"),
  PREFIX = BUI.prefix,
...
define("bui-calendar/1.1.1/src/header-debug", ["jquery","bui-common/1.1.0/common-debug"], function(require, exports, module){
/**
...
var $ = require('jquery'),BUI = require("bui-common/1.1.0/common-debug"),
  PREFIX = BUI.prefix,
  Component = BUI.Component,
...
define("bui-calendar/1.1.1/src/panel-debug", ["jquery","bui-common/1.1.0/common-debug"], function(require, exports, module){
/**
...
define("bui-calendar/1.1.1/src/datepicker-debug", ["bui-common/1.1.0/common-debug","jquery","bui-picker/1.1.2/index-debug","bui-overlay/1.1.0/index-debug","bui-list/1.1.1/index-debug","bui-data/1.1.0/index-debug","bui-toolbar/1.1.0/index-debug"], function(require, exports, module){
/**
 * @fileOverview 日期选择器
 * @author dxq613@gmail.com
 * @ignore
